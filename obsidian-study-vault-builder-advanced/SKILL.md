---
name: obsidian-study-vault-builder-advanced
description: Comprehensive battle-tested patterns for generating academic study vaults in Obsidian. Includes error pattern recognition, systematic fix workflows, quality assurance checklists, and lessons from 828KB/37-file vault projects. For CS students and power users needing comprehensive context.
version: 1.0.0
tags:
  - obsidian
  - education
...
> **Comprehensive patterns from real-world academic vault projects (37 files, 828KB, ~80 hours saved)**

This skill provides battle-tested patterns, error recognition, systematic fixes, and quality standards for building large-scale Obsidian study vaults. Extracted from completed academic final exam preparation projects.

## When to Use This Skill

Use when you need:
- **Comprehensive context** for large academic vault projects (20+ files)
- **Error prevention** patterns before they appear
- **Quality assurance** workflows for consistent output
- **Systematic fix** approaches for common issues
- **Checkpoint workflows** with progressive review
- **Mobile-first** design patterns (no plugin dependencies)

**Target users:** CS students, educators creating study materials, power users building complex Obsidian vaults.

**Companion skill:** Use alongside `obsidian-study-vault-builder` (general version) for quick projects.
